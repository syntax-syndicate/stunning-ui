<template>
  <section
    class="relative mx-auto px-4 sm:px-6 lg:px-8 max-w-screen-lg gap-16 lg:gap-20 flex flex-col py-24 sm:py-32"
  >
    ...
    <div class="grid grid-cols-3 gap-4">
      <div class="rounded p-6 lg:p-8 flex flex-col gap-x-2 gap-y-3">
        ...
        <p class="line-clamp-2 dark:text-muted-foreground">
          {{ paragraphPlaceholder }}
        </p>
