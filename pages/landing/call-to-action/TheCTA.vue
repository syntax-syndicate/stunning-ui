<template>
  <div
    class="container bg-dots border border-neutral-900/90 rounded-xl max-w-screen-lg px-4 py-12 mx-auto sm:py-16 sm:px-24 sm:flex sm:flex-col sm:items-center sm:justify-center sm:gap-8"
  >
    <h2
