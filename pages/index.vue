<template>
  <div class="bg-background">
    <LandingBanner
      :class="
        cn(
          'hidden lg:flex px-paddings relative z-40 overflow-hidden leading-none transition-colors duration-200 dark:bg-neutral-950 dark:hover:bg-neutral-new-8 bg-[#F5FBFD] hover:bg-[#f1fcff]',
    ...
    <section class="container max-w-screen-2xl py-24 sm:py-32 mt-[-120px]">
      <LandingHeadline
        ...
        description="30+ free open-source components that you can copy and paste into your next project."
      />
      <GlowyCardWrapper
