<template>
  ...
  >
    <button
      class="group relative z-[1] bg-transparent dark:text-neutral-50 hover:dark:text-neutral-100 text-neutral-950 hover:text-neutral-900 hover:no-underline"
    >
      <div
      ...
      <div
        class="rounded-lg bg-gradient-to-br from-neutral-50 to-white dark:from-neutral-900 dark:to-neutral-800 px-4 py-1 text-sm"
      >
        <div
